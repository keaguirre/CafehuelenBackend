...
from .views import  compra_list, compra_detail, compras_por_mes_anual, item_compra_list, item_compra_detail, item_compra_auto, compras_recientes, compras_recientes_paginadas, compras_dia_semana, sum_total_compra_week, total_compra_diaria_semanal, total_compra_semanal_anual, total_compra_semanal_mes, total_compra_semanal_mes_anterior, total_compras_hoy, total_compras_mes, total_compras_mes_anterior_x_semana, total_compras_mes_x_semana, total_compras_por_mes_anual, total_compras_semana_anual
urlpatterns = [   
