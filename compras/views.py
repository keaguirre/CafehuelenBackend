...
from productos.models import Ingrediente, Detalle_preparacion
...
def item_compra_auto(request): #implementar la logica
    item_compra_data = JSONParser().parse(request)
    print('icdata: ', item_compra_data)

    for item in item_compra_data:
        id_prep = item['id_prep']
        cant_item = item['cant_item']
        try:
            ...
            for i in det_prep:
                ...
                cant_necesaria_detalle_prep = i.cantidad_necesaria * cant_item
                print('cantidad total resta: ', cant_necesaria_detalle_prep)
                ...
                print('cant_por_ingre: ', ingre.cantidad_por_unidad_ingrediente)
                print('----------------------------------------------')
