...
from .views import categoria_list, categoria_detail, cat_find_id, ingrediente_list, ingrediente_detail, detalle_prep_list, detalle_prep_detail, preparacion_list, preparacion_detail
